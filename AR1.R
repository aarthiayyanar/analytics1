...
freqitems = eclat(tdata, parameter = list(minlen=2, supp=.01, maxlen=3 ))  #support values how many items to display
...
#Quality Data of Rules - display support, comfidence, lift and count
quality(rules_c) 
